...
class getCommandeCrudControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \App\Controller\Admin\CommandeCrudController();

        if (isset($container->services['App\\Controller\\Admin\\CommandeCrudController'])) {
            return $container->services['App\\Controller\\Admin\\CommandeCrudController'];
        }

        $container->services['App\\Controller\\Admin\\CommandeCrudController'] = $instance;

        $instance->setContainer(($container->privates['.service_locator.t0DHw4I'] ?? $container->load('get_ServiceLocator_T0DHw4IService'))->withContext('App\\Controller\\Admin\\CommandeCrudController', $container));
