...
class getAuteurCrudControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \App\Controller\Admin\AuteurCrudController();

        if (isset($container->services['App\\Controller\\Admin\\AuteurCrudController'])) {
            return $container->services['App\\Controller\\Admin\\AuteurCrudController'];
        }

        $container->services['App\\Controller\\Admin\\AuteurCrudController'] = $instance;

        $instance->setContainer(($container->privates['.service_locator.t0DHw4I'] ?? $container->load('get_ServiceLocator_T0DHw4IService'))->withContext('App\\Controller\\Admin\\AuteurCrudController', $container));
